...
Begin VB.Form frmSelecionaLogradouro 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Selecione o Logradouro desejado para o CEP 00000-000"
   ClientHeight    =   3300
   ClientLeft      =   3270
   ClientTop       =   3810
   ClientWidth     =   8460
   ...
   Begin TrueOleDBGrid70.TDBGrid tdb_Lista 
      ...
      Columns(0).Caption=   "intLogradouro"
      Columns(0).DataField=   "intLogradouro"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "Logradouro"
      Columns(1).DataField=   "strLogradouro"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "Bairro"
      Columns(2).DataField=   "strBairro"
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "Município"
      Columns(3).DataField=   "strMunicipio"
      Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(4)._VlistStyle=   0
      Columns(4)._MaxComboItems=   5
      Columns(4).Caption=   "UF"
      Columns(4).DataField=   "strEstado"
      ...
      Splits(0)._ColumnProps(7)=   "Column(1).Width=5900"
      Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=5821"
      Splits(0)._ColumnProps(10)=   "Column(1)._EditAlways=0"
      Splits(0)._ColumnProps(11)=   "Column(1).Order=2"
      Splits(0)._ColumnProps(12)=   "Column(2).Width=3784"
      Splits(0)._ColumnProps(13)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(14)=   "Column(2)._WidthInPix=3704"
      ...
      Splits(0)._ColumnProps(22)=   "Column(4).Width=900"
      Splits(0)._ColumnProps(23)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(24)=   "Column(4)._WidthInPix=820"
   ...
   End
End
Attribute VB_Name = "frmSelecionaLogradouro"
...
Private Sub tdb_Lista_DblClick()
    ...
    If TypeOf gobjGeral Is TextBox Then
        gobjGeral.Text = tdb_Lista.Columns(1).Value
        gobjGeral.Tag = tdb_Lista.Columns(0).Value
        Unload Me
    Else
        AplicarGeral Me, gobjGeral, tdb_Lista, gstrCeps
    End If
End Sub
...
Private Sub tdb_Lista_HeadClick(ByVal ColIndex As Integer)
    ...
    Select Case bytOrdenacao
        Case 1
            strSql = " ORDER BY strLogradouro " & IIf(blnOrdenacaoAsc, " ASC", " DESC")
        Case 2
            strSql = " ORDER BY strBairro " & IIf(blnOrdenacaoAsc, " ASC", " DESC")
        Case 3
            strSql = " ORDER BY strMunicipio " & IIf(blnOrdenacaoAsc, " ASC", " DESC")
        Case 4
            strSql = " ORDER BY strEstado " & IIf(blnOrdenacaoAsc, " ASC", " DESC")
    End Select
    
    LeDaTabelaParaObj gstrCeps, tdb_Lista, strQuery & strSql
End Sub
