...
Begin VB.Form frmCadTipoFeira 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Tipos de Feiras"
   ClientHeight    =   4260
   ClientLeft      =   3285
   ClientTop       =   3120
   ClientWidth     =   5865
   Icon            =   "frmCadTipoFeira.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tab_3dPasta 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Tipo"
      TabPicture(0)   =   "frmCadTipoFeira.frx":1042
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "lblstrDescricao"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "tdb_Lista"
      ...
      Begin TrueOleDBGrid70.TDBGrid tdb_Lista 
         ...
         Splits(0)._ColumnProps(8)=   "Column(1).Width=9525"
         Splits(0)._ColumnProps(9)=   "Column(1).DividerColor=0"
         Splits(0)._ColumnProps(10)=   "Column(1)._WidthInPix=9446"
   ...
   End
End
Attribute VB_Name = "frmCadTipoFeira"
...
Private Function strQueryAplicar() As String
    ...
    strsql = ""
    strsql = strsql & " SELECT PKId, strDescricao FROM "
    strsql = strsql & gstrTipoFeira & " ORDER BY strDescricao"
...
Private Sub Form_Activate()
    ...
    VerificaListaAutomatica gstrTipoFeira, tdb_Lista, ""
    ...
    With tdb_Lista
        If (Not .EOF And Not .BOF) And mblnClickOk Then
            ...
            If mblnPrimeiraVez Then
                LeDaTabelaParaObj gstrTipoFeira, Me
...
Dim strsql As String
    ...
    If strModoOperacao = UCase("IMPRIMIR") Then
        ...
        ToolBarGeral strModoOperacao, gstrTipoFeira, mblnAlterando, tdb_Lista, Me, mobjAux, strsql, , rptTipoFeira, strQueryRelatorio
        Exit Sub
    End If
    ...
    Select Case UCase(strModoOperacao)
        Case gstrSalvar
            ...
            ToolBarGeral strModoOperacao, gstrTipoFeira, mblnAlterando, tdb_Lista, _
...
Function strQueryRelatorio() As String
    ...
    strsql = "SELECT strdescricao FROM " & gstrTipoFeira
...
Private Function blnDadosOk()
    ...
    If Trim(txtstrDescricao.Text) = "" Then
        ExibeMensagem "A o campo descrição é obrigatório"
    ...
    If Not mblnAlterando Or (mblnAlterando And UCase$(txtstrDescricao.Text) <> UCase$(strDescricaoAtual)) Then
        If gblnExisteCodigo(1, gstrTipoFeira, "strDescricao", "'" & txtstrDescricao.Text & "'") Then
