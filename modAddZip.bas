...
' azip32.dll biblioteca de compressao

' declaracao das funcoes para compactacao
...
' aunzip32.dll  addUNZIP biblioteca de descompressao
...
'---------------------------------------------------------------------
Sub gCompacta(cArqCompactado As String, cArq As String)
...
Sub gDesCompacta(cArqCompactado As String, cNomeArq As String, ExtrairPara As String, MontaDir As Boolean)
