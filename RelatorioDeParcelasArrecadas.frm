...
Begin VB.Form frmRelatorioParcelasArrecadadas 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relatório das Parcelas Arrecadadas"
   ClientHeight    =   3105
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7410
   HelpContextID   =   697
   Icon            =   "RelatorioDeParcelasArrecadas.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tab_3dPasta 
      ...
      TabsPerRow      =   1
      TabHeight       =   520
      TabCaption(0)   =   "Relatório das Parcelas Arrecadadas"
      TabPicture(0)   =   "RelatorioDeParcelasArrecadas.frx":1042
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cbo_intUtilizacaoDebito 
            Height          =   315
            ItemData        =   "RelatorioDeParcelasArrecadas.frx":105E
            Left            =   1590
            List            =   "RelatorioDeParcelasArrecadas.frx":1060
            TabIndex        =   3
            Top             =   420
            Width           =   5055
         End
   ...
   End
End
Attribute VB_Name = "frmRelatorioParcelasArrecadadas"
...
If strModoOperacao = gstrImprimir Then
    ...
    If cbo_intUtilizacaoDebito.ListIndex = -1 Then
        ImprimeRelatorio rptRelatorioDeParcelasArrecadas, strSQL, "Relação das Parcelas Arrecadadas"
    ElseIf cbo_intUtilizacaoDebito.ListIndex = 0 Then
        ImprimeRelatorio rptRelatorioDeParcelasArrecadas, strSQL, "Relação das Parcelas Arrecadadas dos Imóveis"
    ElseIf cbo_intUtilizacaoDebito.ListIndex = 1 Then
        ImprimeRelatorio rptRelatorioDeParcelasArrecadas, strSQL, "Relação das Parcelas Arrecadadas dos Apêndices"
    End If
...
'
'    strSQL = strSQL & ", B.strInscricaoCadastral"
'
'    strSQL = strSQL & " FROM "
'    strSQL = strSQL & gstrParcelaReceita & " A, "
'    strSQL = strSQL & gstrLancamentoCalculo & " B, "
