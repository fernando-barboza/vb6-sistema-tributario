...
Begin VB.Form frmRelBaixas 
   ...
   Begin TabDlg.SSTab tab_3dPasta 
      ...
      TabPicture(0)   =   "frmRelBaixas.frx":0000
      ...
      Tab(0).Control(6)=   "dbc_intContaBancaria"
   ...
   End
End
Attribute VB_Name = "frmRelBaixas"
...
On Error Resume Next
    If UCase(strModoOperacao) = UCase(gstrImprimir) Then
        If blnDadosOk Then
            ImprimeRelatorio rptBaixas, strQueryRelatorio
        End If
    End If
...
Dim strSql As String
    ...
    strSql = strSql & gstrISNULL("MB.Dblprincipal", "0") & " AS Dblprincipal, "
    strSql = strSql & gstrISNULL("MB.Dblmulta", "0") & " AS Dblmulta, "
    strSql = strSql & gstrISNULL("MB.Dbljuros", "0") & " AS Dbljuros, "
    strSql = strSql & gstrISNULL("MB.Dblcorrecao", "0") & " AS Dblcorrecao, "
    ...
    strSql = strSql & "MB.Dtmdtmovimento = " & gstrConvDtParaSql(txt_DataMovimento.Text) & " AND "
    strSql = strSql & "MB.Bitprocessado = 1"
