...
Begin VB.Form frmCadRelacaoDeDocumentosDevolvidos 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relação de Documentos Devolvidos"
   ClientHeight    =   2220
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5280
   Icon            =   "cadrelacaodedocumentosdevolvidos.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin TabDlg.SSTab tab_3dPasta 
      ...
      TabsPerRow      =   1
      TabHeight       =   520
      TabCaption(0)   =   "Relação de Documentos Devolvidos"
      TabPicture(0)   =   "cadrelacaodedocumentosdevolvidos.frx":1042
      ...
      Tab(0).Control(5)=   "txt_Devolucao"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "txt_Inicial"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "txt_Final"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "txt_Ate"
   ...
   End
End
Attribute VB_Name = "frmCadRelacaoDeDocumentosDevolvidos"
