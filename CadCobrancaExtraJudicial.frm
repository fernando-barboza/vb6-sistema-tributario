...
Begin VB.Form frmCadCobrancaExtraJudicial 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cobrança Extra-Judicial"
   ClientHeight    =   3630
   ClientLeft      =   2130
   ClientTop       =   2550
   ClientWidth     =   8520
   Icon            =   "CadCobrancaExtraJudicial.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tab_3dPasta 
      ...
      TabsPerRow      =   1
      TabHeight       =   520
      TabCaption(0)   =   "Cobrança Extra-Judicial "
      TabPicture(0)   =   "CadCobrancaExtraJudicial.frx":1042
   ...
   End
End
Attribute VB_Name = "frmCadCobrancaExtraJudicial"
...
Public Sub MantemForm(ByVal strModoOperacao As String)
    ...
    If UCase(strModoOperacao) = UCase(gstrCalcularReajuste) Then
        If blnValidaDados Then
            ...
            strSQL = ""
            strSQL = strSQL & gstrStoredProcedure("sp_Cobranca_Administrativo", "5," & TipoDeInscricao & ",'" & _
                            ...
                            txt_intParcelaInicial & "," & txt_intParcelaFinal & ",NULL," & gstrConvDtParaSql(txt_dtmDataDaExecucao) & "," & glngCodUsr)
            Set gobjBanco = New clsBanco
