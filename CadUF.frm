...
Begin VB.Form frmCadUF 
   ...
   Begin VB.TextBox txtPKId 
      ...
      Width           =   645
   End
   Begin TabDlg.SSTab tab_3dConceito 
      Height          =   3660
      Left            =   105
      TabIndex        =   3
      TabStop         =   0   'False
      ...
      TabsPerRow      =   1
      TabHeight       =   520
      TabCaption(0)   =   "Unidades da Federação"
      TabPicture(0)   =   "CadUF.frx":1042
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "lblstrestado"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "lblstrSigla"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "txtstrEstado"
      ...
      Begin TrueOleDBGrid70.TDBGrid tdb_Lista 
         ...
         Columns(1).DataField=   "strSigla"
         Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(2)._VlistStyle=   0
         Columns(2)._MaxComboItems=   5
         Columns(2).Caption=   "Estado"
         Columns(2).DataField=   "strEstado"
         ...
         Splits(0)._ColumnProps(12)=   "Column(2).Width=5927"
         Splits(0)._ColumnProps(13)=   "Column(2).DividerColor=0"
         Splits(0)._ColumnProps(14)=   "Column(2)._WidthInPix=5847"
...
Private Sub Form_Activate()
    gintCodSeguranca = 1276
    VirificaGradeListView Me
    HabilitaDesabilitaBotao1 mblnAlterando, gstrMnuArquivo, gstrDeletar
    HabilitaDesabilitaBotao1 ((Not mobjAux Is Nothing) And mblnAlterando), _
                              gstrMnuArquivo, gstrAplicar
End Sub
...
Private Sub Form_Load()
    VerificaListaAutomatica "", tdb_Lista, gstrQueryUF(True)
...
Public Sub MantemForm(ByVal strModoOperacao As String)
    ToolBarGeral strModoOperacao, gstrUF, mblnAlterando, tdb_Lista, Me, mobjAux, _
                 gstrQueryUF(True), gstrQueryUF
End Sub

Private Sub txtstrEstado_KeyPress(KeyAscii As Integer)
    CaracterValido KeyAscii
End Sub

Private Sub txtstrSigla_KeyPress(KeyAscii As Integer)
    CaracterValido KeyAscii, "U", txtstrSigla
End Sub

Private Sub txtstrEstado_GotFocus()
    MarcaCampo txtstrEstado
End Sub
