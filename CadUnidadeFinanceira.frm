...
Begin VB.Form frmCadUnidadeFinanceira 
   ...
   ClientWidth     =   4890
   HelpContextID   =   52
   Icon            =   "CadUnidadeFinanceira.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin TabDlg.SSTab tab_3dPasta 
      ...
      TabsPerRow      =   1
      TabHeight       =   520
      TabCaption(0)   =   "Unidade Financeira"
      TabPicture(0)   =   "CadUnidadeFinanceira.frx":1042
   ...
   End
End
Attribute VB_Name = "frmCadUnidadeFinanceira"
...
Private Function strQuery() As String
    ...
    strSql = strSql & gstrUnidadeFinanceira
    strQuery = strSql
End Function

Private Sub Form_Load()
    mblnAlterando = False
    VerificaListaAutomatica gstrUnidadeFinanceira, tdb_Lista
...
Private Sub tdb_Lista_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    With tdb_Lista
        If (Not .EOF And Not .BOF) And mblnClickOk Then
            ...
            LeDaTabelaParaObj gstrUnidadeFinanceira, Me
...
Public Sub MantemForm(ByVal strModoOperacao As String)
    ToolBarGeral strModoOperacao, gstrUnidadeFinanceira, mblnAlterando, tdb_Lista, Me, _
                 mobjAux, strQuery, , rptCadUnidadeFinanceira, strQueryRelatorio
End Sub
