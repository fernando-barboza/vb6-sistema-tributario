...
Begin VB.Form frmISSVarCarneSegundaVia 
   ...
   End
End
Attribute VB_Name = "frmISSVarCarneSegundaVia"
  ...
  Select Case UCase(strModoOperacao)
    ...
    Case Is = UCase(gstrImprimir)
      If blnDadosOk = True Then
         rptCapaCarneISSVar.strParcelasSelecionadas = strParcelas
         rptCapaCarneISSVar.strEmpresaFebraban = strFebraban
         ImprimeRelatorio rptCapaCarneISSVar, strQueryRelatorio
      End If
...
Dim strSql As String
  ...
  strSql = strSql & "WHERE intComposicaoDaReceita = " & dbcstrComposicao.BoundText & " AND "
  strSql = strSql & "intExercicio = " & txtExercicio.Text & " "
...
Dim intCont As Integer
  ...
  strSql = strSql & "LA.intExercicio = " & Trim(txtExercicio.Text) & " AND "
  strSql = strSql & "LVG.intLancamentoAlfa " & strOUTJOracle & "=" & strOUTJSQLServer & " LA.pkID "
