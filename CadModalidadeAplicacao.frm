...
Begin VB.Form frmCadModalidadeAplicacao 
   ...
   Caption         =   "Modalidades de Aplicação"
   ClientHeight    =   4980
   ClientLeft      =   1995
   ClientTop       =   1740
   ClientWidth     =   6600
   ...
   Begin TabDlg.SSTab tab_3DPasta 
      ...
      Tabs            =   1
      TabHeight       =   520
      TabCaption(0)   =   "Modalidades de Aplicação"
      ...
      Begin VB.Frame fra_Convenio 
         ...
         Begin VB.CommandButton cmd_Convenio 
            ...
            TabStop         =   0   'False
            Tag             =   "193"
            ToolTipText     =   "Clique aqui para cadastar convênio"
            Top             =   270
            Width           =   360
         End
      ...
      Begin TrueOleDBGrid70.TDBGrid tdb_Lista 
         ...
         Columns(2).Caption=   "Convênio"
         Columns(2).DataField=   "strConvenio"
         Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(3)._VlistStyle=   0
         Columns(3)._MaxComboItems=   5
         Columns(3).Caption=   "Permite Aplicação"
...
Dim strSQL  As String
    ...
    strSQL = "SELECT tm.PKId, " & gstrCONVERT(CDT_INT, "tm.strCodigo") & " strCodigo, tm.strDescricao, " & gstrCASEWHEN("tm.bytPermiteAplicacao", "0,'Não',1,'Sim'") & " bytPermiteAplicacao, tc.strDescricao strConvenio FROM "
