...
Begin VB.Form frmCadTipoDeAdministracao 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Tipos de Administração"
   ClientHeight    =   3345
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4920
   HelpContextID   =   51
   Icon            =   "CadTipoDeAdministracao.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin TabDlg.SSTab tab_3dPasta 
      ...
      TabsPerRow      =   1
      TabHeight       =   520
      TabCaption(0)   =   "Tipos de Administração"
      TabPicture(0)   =   "CadTipoDeAdministracao.frx":1042
      ...
      Begin TrueOleDBGrid70.TDBGrid tdb_Lista 
         ...
         Splits(0)._ColumnProps(7)=   "Column(1).Width=7329"
         Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
         Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=7250"
   ...
   End
End
Attribute VB_Name = "frmCadTipoDeAdministracao"
...
Private Function strQuery() As String
    ...
    strSql = strSql & gstrTipoAdministracao & " ORDER BY strDescricao"
    strQuery = strSql
End Function

Private Sub Form_Load()
    mblnAlterando = False
    VerificaListaAutomatica gstrTipoAdministracao, tdb_Lista
...
Private Sub tdb_Lista_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    With tdb_Lista
        If (Not .EOF And Not .BOF) And mblnClickOk Then
            ...
            LeDaTabelaParaObj gstrTipoAdministracao, Me
...
Public Sub MantemForm(ByVal strModoOperacao As String)
    ToolBarGeral strModoOperacao, gstrTipoAdministracao, mblnAlterando, _
                 tdb_Lista, Me, mobjAux, strQuery, strQuery, _
                 rptTipoAdministracao, strQueryRelatorio
End Sub
...
Function strQueryRelatorio() As String
    Dim strSql As String
    strSql = ""
    strSql = strSql & "SELECT strDescricao FROM " & gstrTipoAdministracao
