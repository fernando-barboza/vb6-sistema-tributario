...
Begin VB.Form frmCadObjetivo 
   ...
   Begin TabDlg.SSTab tab_3dPasta 
      ...
      TabsPerRow      =   1
      TabHeight       =   520
      TabCaption(0)   =   "Objetivo"
      TabPicture(0)   =   "CadObjetivo.frx":1042
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "lblstrDescricao"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "lblstrCodigo"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "tdb_Objetivo"
      ...
      Begin VB.TextBox txtstrDescricao 
         ...
         Width           =   4350
      End
      Begin TrueOleDBGrid70.TDBGrid tdb_Objetivo 
         Height          =   2745
         Left            =   90
         TabIndex        =   2
         Top             =   1170
         ...
         Splits(0)._ColumnProps(13)=   "Column(2).Width=7964"
         Splits(0)._ColumnProps(14)=   "Column(2).DividerColor=0"
         Splits(0)._ColumnProps(15)=   "Column(2)._WidthInPix=7885"
   ...
   End
End
Attribute VB_Name = "frmCadObjetivo"
...
Private Function blnDadosOk() As Boolean
    ...
    If Not mblnAlterando Then
        If gblnExisteCodigo(1, gstrObjetivo, "strCodigo", "'" & gvntConvFormatoEspecificoParaSQL(txtstrCodigo) & "'") Then
...
'       If Not mblnAlterando Then
            If gblnExisteCodigo(1, gstrObjetivo, "strDescricao", "'" & txtstrDescricao & "'") Then
...
Private Function strQuery() As String
    ...
    strSql = strSql & gstrObjetivo
        
 '  TIMTIM - 14/04/2003
 '  strSql = strSql & gstrObjetivo & " ORDER BY strCodigo, strDescricao"
 '  strQuery = strSql & " ORDER BY PKId"
...
Private Sub Form_Load()
    ...
    Me.Width = 5805
    Me.Height = 4500
    VerificaListaAutomatica gstrObjetivo, tdb_Objetivo, strQuery
...
Private Sub tdb_Objetivo_Click()
    mblnPrimeiraVez = True
    With tdb_Objetivo
        If Not .EOF And Not .BOF Then
            If .Bookmark = 1 Then
                tdb_Objetivo_RowColChange 0, 0
            End If
        End If
    End With
End Sub

Private Sub tdb_Objetivo_DblClick()
    MantemForm gstrAplicar
End Sub

Private Sub tdb_Objetivo_FilterChange()
    gblnFilraCampos tdb_Objetivo
End Sub

Private Sub tdb_Objetivo_KeyPress(KeyAscii As Integer)
    CaracterValido KeyAscii
    If tdb_Objetivo.col = 1 Then
        CaracterValido KeyAscii, "N", tdb_Objetivo
    End If
End Sub

Private Sub tdb_Objetivo_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    With tdb_Objetivo
        If Not .EOF And Not .BOF Then
            If mblnPrimeiraVez Then
                txtPKId.Text = .Columns("PKID").Value
                LeDaTabelaParaObj gstrObjetivo, Me
                
                ' TIMTIM - 14/04/2003
                txtstrDescricao.Tag = txtstrDescricao.Text
            
                gCorLinhaSelecionada tdb_Objetivo
                HabilitaDesabilitaBotao1 True, gstrMnuArquivo, gstrDeletar
                If mobjAux Is Nothing Then
                    HabilitaDesabilitaBotao1 False, gstrMnuArquivo, gstrAplicar
                Else
...
Public Sub MantemForm(ByVal strModoOperacao As String)
    ...
    If UCase(strModoOperacao) = UCase(gstrSalvar) Then
       ...
       If blnDadosOk Then
            ...
            ToolBarGeral strModoOperacao, gstrObjetivo, _
                         mblnAlterando, tdb_Objetivo, Me, _
                         mobjAux, strQuery, , rptObjetivo, strQuerryRelatorio
        End If
    Else
    
        ToolBarGeral strModoOperacao, gstrObjetivo, mblnAlterando, tdb_Objetivo, _
                     Me, mobjAux, strQuery, , rptObjetivo, strQuerryRelatorio
...
Private Sub tlb_BarraFermta_ButtonClick(ByVal Button As MSComctlLib.Button)
    MantemForm Button.Key
End Sub

Private Sub txtstrCodigo_GotFocus()

    ' TIMTIM - 14/04/2003
    gstrProximoCodigo txtstrCodigo, gstrObjetivo, "strCodigo", gintCodSeguranca
...
Dim strSql As String
 ...
 ' TIMTIM - 11/02/2003 - Pendência nº 3
...
' TIMTIM - 14/04/2003
Private Sub tdb_Objetivo_HeadClick(ByVal ColIndex As Integer)
