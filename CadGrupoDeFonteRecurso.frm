...
Begin VB.Form frmCadGrupoDeFonteRecurso 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Grupos de Fonte de Recurso"
   ClientHeight    =   3990
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7050
   Icon            =   "CadGrupoDeFonteRecurso.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tab_3dPasta 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Grupo "
      TabPicture(0)   =   "CadGrupoDeFonteRecurso.frx":1042
      ...
      Begin TrueOleDBGrid70.TDBGrid tdb_Lista 
         ...
         _StyleDefs(21)  =   "Splits(0).HeadingStyle:id=14,.parent=2,.namedParent=38"
   ...
   End
End
Attribute VB_Name = "frmCadGrupoDeFonteRecurso"
...
Private Function strQuery(Optional blnAplicar As Boolean) As String
    ...
    If blnAplicar Then
        ...
        strSql = strSql & gstrGrupoDeFonteRecurso
    Else
...
Private Sub tdb_Lista_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    With tdb_Lista
        If (Not .EOF And Not .BOF) And mblnClickOk Then
            ...
            LeDaTabelaParaObj gstrGrupoDeFonteRecurso, Me
            If mobjAux Is Nothing Then
                HabilitaDesabilitaBotao1 False, gstrMnuArquivo, gstrAplicar
            Else
                HabilitaDesabilitaBotao1 True, gstrMnuArquivo, gstrAplicar
...
Public Sub MantemForm(ByVal strModoOperacao As String)
    ToolBarGeral strModoOperacao, gstrGrupoDeFonteRecurso, mblnAlterando, tdb_Lista, _
                Me, mobjAux, strQuery, strQuery(True), _
                rptCadGrupoDeFonteRecurso, strQueryRelatorio
End Sub
