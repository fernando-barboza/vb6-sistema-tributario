...
Begin VB.Form frmCadSubfuncaoDoGoverno 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Subfunções de Governo"
   ClientHeight    =   4695
   ClientLeft      =   1350
   ClientTop       =   2160
   ClientWidth     =   8115
   HelpContextID   =   18
   Icon            =   "CadSubfuncaoDoGoverno.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin TabDlg.SSTab tab_3dPasta 
      ...
      TabsPerRow      =   1
      TabHeight       =   520
      TabCaption(0)   =   "Subfunções de Governo"
      TabPicture(0)   =   "CadSubfuncaoDoGoverno.frx":1042
      ...
      Begin TrueOleDBGrid70.TDBGrid tdb_Lista 
         ...
         Splits(0)._ColumnProps(8)=   "Column(1).Width=1746"
         Splits(0)._ColumnProps(9)=   "Column(1).DividerColor=0"
         Splits(0)._ColumnProps(10)=   "Column(1)._WidthInPix=1667"
         Splits(0)._ColumnProps(11)=   "Column(1)._EditAlways=0"
         Splits(0)._ColumnProps(12)=   "Column(1).Order=2"
         Splits(0)._ColumnProps(13)=   "Column(2).Width=11192"
         Splits(0)._ColumnProps(14)=   "Column(2).DividerColor=0"
         Splits(0)._ColumnProps(15)=   "Column(2)._WidthInPix=11113"
   ...
   End
End
Attribute VB_Name = "frmCadSubfuncaoDoGoverno"
...
Dim strSQL  As String
    ...
    strSQL = "SELECT PKId, strCodigo, strDescricao FROM " & gstrSubFuncaoGoverno & " WHERE intExercicio = " & intFiltroExercicio
...
Private Sub Form_Load()
    ...
    LeDaTabelaParaObj gstrSubFuncaoGoverno, tdb_Lista, strQuery
...
Private Sub tdb_Lista_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    With tdb_Lista
        If (Not .EOF And Not .BOF) And mblnClickOk Then
            ...
            LeDaTabelaParaObj gstrSubFuncaoGoverno, Me
...
Public Sub MantemForm(ByVal strModoOperacao As String)
    ...
    Case Is = gstrSalvar
        ...
        If Not mblnAlterando Then
            If gblnExisteCodigo(1, gstrSubFuncaoGoverno, "strDescricao", "'" & txtstrDescricao & "'") Or gblnExisteCodigo(1, gstrSubFuncaoGoverno, "strCodigo", "'" & txtstrCodigo & "'") Then
                MsgBox "Esta sub-função já se encontra cadastrada.", vbOKOnly, "Mensagem ao Usuário"
                Exit Sub
            End If
        End If
        
    Case Is = gstrImprimir
        If rptSubFuncaoDoGoverno.Enabled Then Unload rptSubFuncaoDoGoverno
        If gbytMenu = gbytMenuCadastro Then
        intFiltroExercicio = gintExercicio
            Else
        intFiltroExercicio = gintExercicio + 1
    ...
    ToolBarGeral strModoOperacao, gstrSubFuncaoGoverno, mblnAlterando, tdb_Lista, Me, _
                 mobjAux, strQuery, strQueryAplicar, rptSubFuncaoDoGoverno, strQuery
...
Private Sub LimpaCampos()
    ...
    gstrProximoCodigo txtstrCodigo, gstrSubFuncaoGoverno, "strCodigo", gintCodSeguranca, , , , , , , "intExercicio", CStr(intFiltroExercicio)
...
Private Function blnDadosOk() As Boolean
  Dim i As Integer
    ...
    'If Len(txtstrCodigo) < 3 Then
        'i = Len(txtstrCodigo)
        'While i < 3
           'txtstrCodigo = "0" & txtstrCodigo
           'i = i + 1
        'Wend
    'End If
    ...
    End If
        ...
        'If gblnExisteCodigo(1, gstrSubFuncaoGoverno, "strCodigo", "'" & gvntConvFormatoEspecificoParaSQL(CInt(txtstrCodigo)) & "'", , , , , " AND intExercicio = " & intFiltroExercicio) Then
...
Private Function strQueryAplicar() As String
    strQueryAplicar = "SELECT PKId, strDescricao FROM " & gstrSubFuncaoGoverno & " WHERE intExercicio = " & intFiltroExercicio
End Function
...
Private Function ConsultaCodigo(strCodigo As String) As String
 ...
 Dim adoResultado As New ADODB.Recordset
    ...
    strSQL = strSQL & " From "
    strSQL = strSQL & gstrSubFuncaoGoverno
    strSQL = strSQL & " Where "
    strSQL = strSQL & "intExercicio=" & intFiltroExercicio
