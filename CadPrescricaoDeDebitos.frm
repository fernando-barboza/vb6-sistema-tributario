...
Begin VB.Form frmCadPrescricaoDeDebitos 
   ...
   Begin TabDlg.SSTab tab_3dPasta 
      ...
      TabsPerRow      =   1
      TabHeight       =   520
      TabCaption(0)   =   "Prescrição de Débitos"
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Label lbl_intLei 
            ...
            AutoSize        =   -1  'True
            Caption         =   "N° do Processo da Prescrição"
            Height          =   195
            Left            =   4500
            TabIndex        =   16
            Top             =   1875
...
Private Function blnValidaDados() As Boolean
    ...
    If Trim(txt_dtmDataDaPrescricao.Text) = "" Then
        ExibeMensagem " A Data da Prescrição tem que ser digitada."
