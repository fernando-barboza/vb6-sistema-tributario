...
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} rptCapaCarneISSVar 
   Caption         =   "Tributario - rptCapaCarneISSVar (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15240
   ...
   _ExtentX        =   26882
   _ExtentY        =   19076
   SectionData     =   "rptCapaCarneISSVariavel.dsx":0000
End
...
Dim lngContaBancaria  As Long
    ...
    VerificaIndexadorEconomico '->Verifico na tabela Parametros Tributario o intIndexadorEconomico
  ...
  End If
    ...
    If Not adoDataControl.Recordset.EOF Then
        ...
        If Not lngContaBancaria = 0 Then 'Ficha Compensacao
        ...
        Else 'Febraban
            ...
            Set subParcelas.object = rptBoletoFebraban
...
Dim intCont As Integer
  ...
  strSql = strSql & "ORDER BY LV.intParcela, LA.strInscricao "
  
  strQueryParcelas = strSql
End Function

Private Sub VerificaIndexadorEconomico()
'*****************************************************************************************
'   Programador:        Éder Henrique
'   Módulos:            Tributário
'   Data:               13/01/2006
'   Ficha:              tri0536
'   Objetivo:           Verificar o Indexador Economico
'*****************************************************************************************
...
Dim adoResultado As ADODB.Recordset
    ...
    strSql = ""
    strSql = strSql & "SELECT "
    strSql = strSql & "PT.intIndexadorEconomico "
    strSql = strSql & "FROM "
    ...
    If gobjBanco.CriaADO(strSql, 5, adoResultado) Then
        If Not adoResultado.EOF Then
            blnSemIndexador = Val(gstrENulo(adoResultado("intIndexadorEconomico").Value)) = 1
        Else
            blnSemIndexador = 0
        End If
    End If
